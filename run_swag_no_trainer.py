...
def parse_args():
    ...
    parser.add_argument("--output_dir", type=str, default='/home/yiz/Desktop/ADLHW1/output', help="Where to store the final model.")
...
def main():
    ...
    for epoch in range(starting_epoch, args.num_train_epochs):
        ...
        epoch_loss_values.append(avg_loss)  # 将平均损失值添加到列表中
    ...
    # 训练结束后，绘制损失曲线
    plt.figure()
    plt.plot(range(1, args.num_train_epochs + 1), epoch_loss_values, marker='o')
    plt.xlabel('Epoch')
